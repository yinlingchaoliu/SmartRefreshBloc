...
import 'TestExample.dart';
import 'TestExample2.dart';
import 'TestExample3.dart';
...
//    );
          ...
          new MaterialButton(
              onPressed: () {
                tabIndex == 2
                    ...
                    : tabIndex == 0
                        ? example1Key.currentState.scrollTop()
                        : _changePage();
              },
              child: new Text(
                tabIndex == 2 ? 'refresh3' : tabIndex == 0 ? "滚回顶部" : "跳转页面",
  ...
  void initState() {
    ...
    views = [
      TestExamplePage.newInstance(),
//      new Example1(key: example1Key),
//      new Example2(),
      TestExample2Page.newInstance(),
      TestExample3Page.newInstance(),

//      new Example3(key: example3Key),
      new Example4()
    ];
    super.initState();
  }
